...
return new class extends AiMigration
{
    ...
    public function up(): void
    {
        ...
        Schema::create($conversationsTable, function (Blueprint $table) {
            ...
            // DIUBAH: unsignedBigInteger -> uuid, karena users.id di project ini
            // ber-tipe UUID (bukan bigint auto-increment).
        ...
        Schema::create($messagesTable, function (Blueprint $table) {
            ...
            $table->string('participant_type')->nullable();
            // DIUBAH: sama seperti di atas, uuid bukan unsignedBigInteger.
            $table->uuid('participant_id')->nullable();
            $table->string('agent');
